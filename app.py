...
with open('Q&A Boiler chemistry.csv') as file:
...
import chardet
    ...
    file_name = 'Q&A Boiler chemistry.csv'

    with open(Q&A Boiler chemistry.csv, 'rb') as file:  # Open in binary mode
...
# Open the file in binary mode to detect encoding
# Correct the file name usage in the 'open' function
with open('Q&A Boiler chemistry.csv','rb') as file:  # Use file_name instead of Q&A Boiler chemistry.csv
    result = chardet.detect(file.read(10000))
    print(result)
